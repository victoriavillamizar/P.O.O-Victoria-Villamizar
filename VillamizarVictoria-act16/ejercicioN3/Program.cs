...
namespace ejercicioN3
{
    ...
    class Vehiculo
    {
        ...
        public Vehiculo(string marcaa, double velocidadMaximaa)
        {
            marca = marcaa;
            velocidadMaxima = velocidadMaximaa;
        }
        ...
        class Auto : Vehiculo
        {
            ...
            public Auto(string marcaa, double velocidadMaximaa, int cantidadPuertass): base ( marcaa, velocidadMaximaa)
            {
                cantidadPuertas = cantidadPuertass;
            }
            ...
            class Moto : Vehiculo
            {
                ...
                public Moto(string marcaa, double velocidadMaximaa, int cilindradaMotoo): base( marcaa, velocidadMaximaa)
                {
                    cilindradaMoto = cilindradaMotoo;
                }
